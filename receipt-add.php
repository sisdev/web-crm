...
{
	alert("Receipt add successfully....");
}
</script>
...
$(document).ready(function(){
	$("#reg_no").change(function(){
		...
		if(username.length > 4){
			...
			$.ajax({
				type: "POST",
				url: "receipt-registration-no-ajax.php",
				data: "reg="+ username,  
...
<label class="col-md-2 control-label" for="ins_no">Instrument No<span style="color:red">*</span></label>  
  ...
  <div class="col-md-3">
	<input name="ins_date" id="ins_dt" class="form-control input-md" type="date" >
  </div>
  </div>
