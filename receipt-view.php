...
if(isset($_POST['delete_id']))
{
    ...
    header("location:receipt-view.php");
	exit;
}
?>
...
<div class ="container-fluid" >
 ...
 <div style="margin-top:100px;">
  <h2 class="text-primary text-center">Manage Receipt</h2>
</div> 
 <div id="no-more-tables">
<table class="table table-bordered table-stripped table-responsive table-condensed cf col-sm-12" style="text-align:center;" id="myTable">

    <thead class="cf">
      <tr >
        <th style='color:#b30059; text-align:center;'>#</th>
        <th style='color:#b30059; text-align:center;'>Receipt No</th>
...
if($_GET['page'])
{
	$result=mysqli_query($conn,"select * from tbl_receipt order by rct_no desc LIMIT $start, $max");
	$j=$_GET['page'];
	$j= $j*10+1;
}
else
...
?>
		<tbody>
			...
			<form action = "receipt-view.php" method="POST" onClick="return confirmDelete(this)">
...
echo "<li><a href='receipt-view.php?page=".($page-1)."' aria-lable='Previous' ><span aria-hidden='true'>&laquo;</span>
        <span class='sr-only'>Previous</span></a></li>"; 


    echo "<li><a href='receipt-view.php?page=".$page."'>".$page."</a></li>";


echo "<li><a href='receipt-view.php?page=".($page+1)."' aria-lable='Next'> <span aria-hidden='true'>&raquo;</span>
