...
?>
		<tbody>
			...
			<td data-title="Registration No"><?php echo $row['rct_no'] ?></td>			
			...
			<form action = "payment-view.php" method="POST" onClick="return confirmDelete(this)">
...
echo "<li><a href='payment-view.php?page=".($page-1)."' aria-lable='Previous' ><span aria-hidden='true'>&laquo;</span>
        <span class='sr-only'>Previous</span></a></li>"; 


    echo "<li><a href='payment-view.php?page=".$page."'>".$page."</a></li>";


echo "<li><a href='payment-view.php?page=".($page+1)."' aria-lable='Next'> <span aria-hidden='true'>&raquo;</span>
