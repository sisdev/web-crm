...
<html>
<head>
<title><?php echo $pkg_name; ?>-Sales Deal Report For Duration</title>
...
<div style="margin-top:90px;">
  <h2 class="text-primary text-center" style="margin-right:1%;">Sales-DEAL Report For Duration</h2>
</div> 
...
<table class="table table-bordered table-stripped table-responsive table-condensed" style="text-align:center; margin-bottom:80px;" id="myTable">
   ...
   <?php  
	$dur_qry="select * from deal_log where enroll_dtm between '".$date1."' and '".$date2."' order by enroll_dtm desc";
	//echo $dur_qry;
...
?>
		<tbody>
				<tr>
					...
					<td data-title="Date"><?php echo $row['enroll_dtm'];?></td>
...
<?php		
  $total_fees+=$fees;
   ...
   echo "<div style='margin-top:-30px; margin-bottom:3px; float:right; width:150px; height: 30px; border-radius:0; box-shadow: 0 2px 4px 0 rgba(0,0,0,0.2), 0 2px 8px 0 rgba(0,0,0,0.19);'>Total Fees: <b>".$tot_fee."</b></div>";	
