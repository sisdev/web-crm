...
<div class ="container">   	
	...
	<div class="col-md-2">
	<ul class="pager">
	<li class="previous"><a href="payment-view.php"><< Back</a></li>
	</ul>
	</div>
	<div class="col-md-8">
	<h2 class="text-primary text-center">Update Payment-Details</h2>
	</div> 
	</div>
	<form class="form-horizontal" style="margin-left:12%;" action="payment-update-record.php" method="post" enctype="multipart/form-data"  onSubmit="return validateForm(this)">
...
<div class="form-group" style="margin-left:35%;">
  ...
  <div>
	...
	<input type="reset"  name="Reset" class="btn" value="Cancel" onClick="location.href = 'payment-view.php';" style="padding:10px 7%;"/>
	</div>
</div>
</form>
		
</div>
<div style="position:relative; margin-top:116px;">
